  ...
  return (
    <div className="rounded-2xl border border-white/10 bg-[#0a0a12] p-4 overflow-x-auto">
      <svg viewBox="0 0 1100 320" className="min-w-[920px] w-full h-auto" role="img" aria-label="QStash backbone architecture">
        ...
        <text x="665" y="118" fill="#9ca3af" fontSize="12" textAnchor="middle">valdyum.payment.pending</text>
        <text x="665" y="142" fill="#9ca3af" fontSize="12" textAnchor="middle">valdyum.payment.confirmed</text>
        <text x="665" y="166" fill="#9ca3af" fontSize="12" textAnchor="middle">valdyum.agent.completed</text>
        <text x="665" y="190" fill="#9ca3af" fontSize="12" textAnchor="middle">valdyum.billing.updated</text>
        <text x="665" y="214" fill="#9ca3af" fontSize="12" textAnchor="middle">valdyum.marketplace.activity</text>
