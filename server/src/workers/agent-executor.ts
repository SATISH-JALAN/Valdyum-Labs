 ...
 *
 * Listens on `valdyum.payment.confirmed`.
 *
 ...
 *  4. Publishes `valdyum.agent.completed` for downstream consumers.
 */

import { createClient } from '@supabase/supabase-js';
import { createConsumer, publish } from '../services/qstash';
import { TOPICS, type PaymentConfirmedEvent, type AgentCompletedEvent } from '@valdyum/shared';

const CONSUMER_GROUP = 'valdyum-agent-executor';
