...
const NETWORK_PASSPHRASE =
  (process.env.STELLAR_NETWORK || process.env.NEXT_PUBLIC_STELLAR_NETWORK) === 'mainnet'
    ? StellarSdk.Networks.PUBLIC
    : StellarSdk.Networks.TESTNET;

const VALIDATOR_CONTRACT_ID = process.env.SOROBAN_VALIDATOR_ID || process.env.NEXT_PUBLIC_SOROBAN_VALIDATOR_ID || '';
const REGISTRY_CONTRACT_ID = process.env.SOROBAN_CONTRACT_ID || process.env.NEXT_PUBLIC_SOROBAN_CONTRACT_ID || '';
